...
export function ChatItem({ id, content, member, timestamp, fileUrl, deleted, currentMember, isUpdated, socketUrl, socketQuery }: ChatItemProps) {
    ...
    <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full">
      <div className="group flex gap-x-2 items-center w-full">
        ...
        <div className="flex flex-col w-full">
          ...
          {!fileUrl && !isEditing && (
            <p className={cn("text-sm text-zinc-600 dark:text-zinc-300", deleted && "italic to-zinc-500 dark:text-zinc-400 text-xs mt-1")}>
              {content}
